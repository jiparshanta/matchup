      ...
      <Card className="shadow-xl shadow-gray-200/50 border-0">
        <CardContent className="p-5 sm:p-6">
          ...
          <p className="text-gray-500 text-sm mb-6">
            Join MatchUp and find pickup games near you
          </p>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-gray-200 px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-emerald-100 focus:border-emerald-500 transition-all"
              />
